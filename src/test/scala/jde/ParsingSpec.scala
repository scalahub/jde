...
class ParsingSpec extends WordSpec with MockitoSugar with Matchers with TraitTokenFilter with TraitTimestamp with TraitDummyProtocol {
  "Protocol parser" should {
    "parse constants from token-filter.json correctly" in {
      ...
      constants(3) shouldEqual Constant(name = "9f5ZKbECVTm25JTRQHDHGM5ehC8tUw5g1fCBQ4aaE792rWBFrjK", DataType.Address, value = Some("9f5ZKbECVTm25JTRQHDHGM5ehC8tUw5g1fCBQ4aaE792rWBFrjK"), None)
    ...
    "parse constants from timestamp.json correctly" in {
      ...
      constants(0) shouldEqual Constant(name = "myBoxId", `type` = DataType.CollByte, value = Some("506dfb0a34d44f2baef77d99f9da03b1f122bdc4c7c31791a0c706e23f1207e7"), None)
      constants(1) shouldEqual Constant(
      ...
      constants(3) shouldEqual Constant(name = "myTokenId", `type` = DataType.CollByte, value = Some("dbea46d988e86b1e60181b69936a3b927c3a4871aa6ed5258d3e4df155750bea"), None)
    ...
    "parse protocol from dummy.json correctly" in {
      val str = scala.io.Source.fromFile("src/test/resources/dummy.json").getLines.mkString
    ...
    "parse constants from dummy.json correctly" in {
      ...
      constants(1) shouldEqual Constant("myCollByte", DataType.CollByte, Some("506dfb0a34d44f2baef77d99f9da03b1f122bdc4c7c31791a0c706e23f1207e7"), None)
      constants(2) shouldEqual Constant("myInt", DataType.Int, Some("1234"), None)
      constants(3) shouldEqual Constant("myTokenId", DataType.CollByte, Some("ae57e4add0f181f5d1e8fd462969e4cc04f13b0da183676660d280ad0b64563f"), None)
      constants(4) shouldEqual Constant("myGroupElement", DataType.GroupElement, Some("028182257d34ec7dbfedee9e857aadeb8ce02bb0c757871871cff378bb52107c67"), None)
